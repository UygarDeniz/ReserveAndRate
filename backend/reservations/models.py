...
class BusinessHours(models.Model):
    ...
    """
    restaurant = models.ForeignKey(Restaurant, on_delete=models.CASCADE, default=15)
...
class Reservation(models.Model):
    ...
    """
    time_slot = models.ForeignKey(TimeSlot, on_delete=models.CASCADE, related_name='reservation')
